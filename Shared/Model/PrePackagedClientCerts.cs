...
public record ClientCertEntry(string Name, string CertificateName, string Description);

public static class PrePackagedClientCerts
{
    public static readonly IReadOnlyList<ClientCertEntry> Entries = new List<ClientCertEntry>
    {
